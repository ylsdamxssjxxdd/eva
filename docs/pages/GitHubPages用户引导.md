...
- **多模态对话**：文本、图片、文档、音频/录音一并发送，支持监视帧与 reasoning 块显示。
...
## 功能导航（按顺序体验，或按需跳转）
1.  **[对话：日常聊天](01-对话.md)** – 基础聊天、多模态输入、状态灯与快捷键。
2.  **[补完：初始形态](02-补完.md)** – 一次性长文/代码续写，单轮重置不带历史。
3.  **[语音交互：开麦即聊](03-语音交互.md)** – F2 录音转写、音频上传、Whisper 选择。
4.  **[视觉交互：看图说话](04-视觉交互.md)** – 截图/上传、多图提问、视觉模型挂载与监视帧。
5.  **[文生图：幻想成真](05-文生图.md)** – Stable Diffusion/Flux 生成流程、参数与风格技巧。
6.  **[知识库：你的私有仓库](06-知识库.md)** – 嵌入服务、入库/检索、引用回答。
7.  **[MCP：连接外部服务](07-MCP.md)** – SSE/streamable/stdio 接入、工具回填与多服务协同。
8.  **[系统工程师：命令与编程协作](08-系统工程师.md)** – 命令/读写/ptc 脚本、工作目录与安全限制。
9.  **[使用沙盒：把高风险关进盒子](09-使用沙盒.md)** – Docker 镜像/容器模式、挂载与就绪判定。
10. **[使用技能：外挂式工作流](10-使用技能.md)** – 技能包安装/启用/卸载，路径注入系统提示。
11. **[系统架构师：代理的代理](11-系统架构师.md)** – 需求澄清、方案设计、接口与风险输出。
12. **[机体控制：远程接管](12-机体控制.md)** – 开启远程控制、连接/解除、协同安全建议。
