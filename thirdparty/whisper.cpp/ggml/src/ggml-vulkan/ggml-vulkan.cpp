...
// Provide storage for the default dynamic dispatcher in this TU to satisfy
// default-argument usage inside vulkan_hpp split headers on MSVC.
// This emits the definition of vk::defaultDispatchLoaderDynamic.
...
// Using Vulkan-Hpp default dynamic dispatcher storage; the legacy custom
// dispatcher is disabled to avoid MSVC default-argument ordering issues.
#if 0
